...
% These labs will be conducted using a virtual machine (VM) which we will provide you. To run this VM, you will need to download and install a software called VirtualBox (available for Windows, macOS, and Linux) on your personal computer. See the VirtualBox Setup Guide handout for details on how to install and set up the VM.
