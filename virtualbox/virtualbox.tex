...
\useCompactTitle{ECE361}{VirtualBox and Course VM Setup Guide}
...
\work{To generate a key to associate this VM with your UG EECG account, open a terminal (in the VM), and type \texttt{ece361-init}}
