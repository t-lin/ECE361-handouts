...
\figvs{0.4}{tshoot-guest-ext-1}{trim=0cm 0cm 0cm 0cm,clip}{Insert the GuestAdditions CD image.}
...
\figvs{0.4}{tshoot-guest-ext-2}{trim=0cm 0cm 0cm 0cm,clip}{Execute the installation process.}
...
\figvs{0.4}{tshoot-scale-1}{trim=0cm 0cm 0cm 0cm,clip}{Enable Scaled Mode.}

\textbf{Step 5:} Find the VM's monitor settings, and adjust the resolution as you see fit.
\figvs{0.4}{tshoot-scale-2}{trim=0cm 0cm 0cm 0cm,clip}{Adjust the Monitor Settings.}
