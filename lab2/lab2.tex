...
\begin{lstlisting}[language=bash]
$ python3 receiver.py received.txt
\end{lstlisting}
From the h2 terminal:
\begin{lstlisting}[language=bash]
$ python3 sender.py text_file_small.txt
\end{lstlisting}
...
From the h1 terminal:
\begin{lstlisting}[language=bash]
$ python3 receiver.py --debug received.txt
\end{lstlisting}
From the h2 terminal:
\begin{lstlisting}[language=bash]
$ python3 sender.py --debug text_file_small.txt
\end{lstlisting}
...
From the h1 terminal:
\begin{lstlisting}[language=bash]
$ python3 receiver.py received
\end{lstlisting}
From the h2 terminal:
\begin{lstlisting}[language=bash]
$ python3 sender.py binary_file_large
\end{lstlisting}
